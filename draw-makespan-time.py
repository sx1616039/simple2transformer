...
if __name__ == "__main__":
    x_labels1 = ['la01', 'la02', 'la03', 'la04', 'la05', 'la06', 'la07', 'la08', 'la09', 'la10',
    ...
    x_labels = ['MK1', 'MK2', 'MK3', 'MK4', 'MK5', 'MK6', 'MK7', 'MK8', 'MK9', 'MK10']

    trajectories = pd.read_excel("draw_makespan_time/transformer-trajectory.xls")
    traj = trajectories.values[:, 1:6]
    time = pd.read_excel("draw_makespan_time/transformer-time.xls")
